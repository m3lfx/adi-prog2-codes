...
class MyGUI:
    def __init__(self):
        ...
        self.cb_var1 = tkinter.StringVar()
        ...
        self.cb1 = tkinter.Checkbutton(self.top_frame, text='Option 1', variable=self.cb_var1, onvalue="A", offvalue=0)
        self.cb2 = tkinter.Checkbutton(self.top_frame, text='Option 2', variable=self.cb_var2, onvalue="B")
        self.cb3 = tkinter.Checkbutton(self.top_frame, text='Option 3', variable=self.cb_var3, onvalue="C")
